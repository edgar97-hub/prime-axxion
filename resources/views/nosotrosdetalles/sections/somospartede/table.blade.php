            ...
            <tr> 
              ...
              <img height="50" src="{{ asset('storage/'.$value->img) }}" alt="" title="">
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('nosotrosdetalles.showTextImg', [$value->id]) }}" class='btn btn-ghost-success'><i class="fa fa-eye"></i></a>
                        <a href="{{ route('nosotrosdetalles.editTextImg', [$value->id]) }}" class='btn btn-ghost-info'><i class="fa fa-edit"></i></a>
